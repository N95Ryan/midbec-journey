...
- **Organisation et outils de pilotage**  
  ...
  - Préparation d’un message de commit cohérent (`refactor/frontend : 'rebuild header topbar and shell layout'`) pour encapsuler la journée.
