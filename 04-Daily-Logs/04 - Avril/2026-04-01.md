...
La bonne humeur n'est pas de sortie aujourd'hui, j'ai de la famille qui s'impose chez moi ce week-end. Week-end de 3 jours en plus. Ça m'énerve, sincèrement. Parce que c'est justement pour ça que j'ai choisi de prendre mon indépendance. Je suis très irrité : Je ne VEUX pas recevoir des gens.
...
6/10 : Journée productive malgré l'irritation du contexte perso. `ServicesBanner` + `FeaturedProducts` livrés proprement. Bonne leçon sur les prompts chirurgicaux, `git diff`, provider scope et UI first.