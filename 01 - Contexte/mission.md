...
**Localisation** : Drummondville, QC, Canada
...
Modernisation complète du site web Midbec — migration d'une stack
legacy vieille de 50 ans vers une architecture moderne et scalable
(Next.js / Go).

Enjeux : sécurité critique, performance, maintenabilité, et scalabilité
pour un catalogue en croissance de 500k vers 2 millions de pièces.
