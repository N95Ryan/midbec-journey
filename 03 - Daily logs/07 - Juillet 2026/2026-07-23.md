...
*Contexte : un scope récemment livré et validé n'avait jamais été documenté formellement.*
...
*Contexte : session courte avec l'infra pour définir le périmètre technique avant tout développement.*
