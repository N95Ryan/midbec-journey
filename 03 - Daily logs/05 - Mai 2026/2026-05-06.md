...
- Audit de toutes les `page.tsx` sous `src/app/[locale]/` — état réel documenté
...
- Mail de relance envoyé à Dennis.Lucas@LeadVenture.com (Patrick en copie) — ticket CAS-859768-V8J4N4
...
- Les clés i18n `NAV_BLOG` dans `fr.json` et `en.json` sont toujours présentes — à nettoyer dans un prochain passage

## ⏭️ Next steps

- Attendre réponse PartSmart (Dennis) sur la doc API — Scope 8 bloqué
- Nettoyer les clés i18n `NAV_BLOG` orphelines
