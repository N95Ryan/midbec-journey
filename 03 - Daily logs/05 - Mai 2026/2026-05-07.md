...
- Rédiger la documentation technique dans `midbec-go-api/docs/`
...
- Rédaction de `docs/partsmart-auth.md` — flow d'auth, endpoints, tokens, Postman
- Rédaction de `docs/partsmart-integration.md` — embedding, deep linking, cart, picklist
- Commit `chore/partsmart-docs` sur `midbec-go-api`
