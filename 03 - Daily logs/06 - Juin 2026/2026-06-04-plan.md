...
- [x] Commits 3x (go-api, front, journey) + MR `feat/UnoPIM-*` vers develop
- [x] `permanentRedirect` shop/page, shop/[slug], produit/[slug] + fix slides homepage
- [x] Smoke manuel : /shop, /shop/slug PIM, /produit/sku, panier OK
- [x] Supprimer `headerDepartments.ts` + MAJ unopim-roadmap cleanup
- [x] Rédiger `2026-06-04.md` fin de journée
